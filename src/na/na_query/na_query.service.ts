    ...
    try {
      ...
      const dnhpdareport_response = await this.prisma.na_query.create({
        data: {
          ...
          na_formId: naid,
          type: 'REPORT',
          to_userId: na_form.village?.pda_id ?? 17,
          query: dnhpdareport,
        },
      });
      ...
      const talathireport_response = await this.prisma.na_query.create({
        data: {
          ...
          na_formId: naid,
          type: 'REPORT',
          to_userId: na_form.village?.talati_id ?? 11,
          query: talathireport,
        },
      });
